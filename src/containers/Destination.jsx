        ...
        <main className='destination'>
            <h2 className='destination_statement'><span>01</span>pick your destination</h2>
                ...
                <figure className='destination_figure'>
                    <img className='destination_image' src= {planet.image} alt="" />
                </figure>
                <div>
                    <nav className='destination_nav'>
                        <ul className='destination_nav-list'>
                            ...
                            <li className='destination_nav-item'>
                                <Link to={`/destination`} onClick={() => setPlanet({
                                    name: 'europe',
                                    image: europe,
                    ...
                    <h2 className='destination_planet'>{planet.name}</h2>
                    <p className='destination_planet-description'>{planet.description}</p>
